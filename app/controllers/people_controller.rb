class PeopleController < ApplicationController
  ...
  before_action :load_parent, only: [:show, :edit, :destroy, :index, :new]
  before_action :load_parent_update, only: [:update]
  ...
  #  @person = Person.organizations.build
